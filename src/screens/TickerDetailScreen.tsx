...
export default function TickerDetailScreen() {
    ...
    const {data: tickerDetail, isLoading, error} = useQuery({
                ...
                <View style={styles.priceHeader}>
                    ...
                    <View style={styles.headerActions}>
                        ...
                        <View style={[
                            ...
                            {backgroundColor: ticker.market_type === 'crypto' ? theme.colors.primary : theme.colors.secondary}
                        ]}>
                            <Text style={styles.marketTypeText}>
                                {ticker.market_type.toUpperCase()}
                            </Text>
                        </View>
                    </View>
                </View>
